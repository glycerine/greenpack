/*
package zebra specifies the Greenpack serialization format.
...
by running `greenpack` into msgpack2 (with optional JSON)
...
`greenpack -file zebra.go` on this file itself.
