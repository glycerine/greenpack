...
func (z *Middle2) MarshalMsg(b []byte) (o []byte, err error) {
	...
	if !empty[0] {
		...
		for zgensym_29db2bb3a798cb07_12 := range z.Children {
			o, err = msgp.AppendIntf(o, z.Children[zgensym_29db2bb3a798cb07_12]) // is.iface, gen/marshal.go:237, b='&gen.BaseElem{Common:gen.Common{vname:"z.Children[zgensym_29db2bb3a798cb07_12]", alias:"Shouter2", generic:(*gen.Genric)(nil), hmp:gen.HasMethodPrefix(nil), zid:0}, ShimToBase:"", ShimFromBase:"", Value:0x16, Convert:false, mustinline:false, needsref:false, isIface:true, isInIfaceSlice:true}'
			if err != nil {
				return
			}
		}
...
func (z *NoDedup) MarshalMsg(b []byte) (o []byte, err error) {
	...
	if !empty[2] {
		...
		o, err = msgp.AppendIntf(o, z.MyIface0) // is.iface, gen/marshal.go:237, b='&gen.BaseElem{Common:gen.Common{vname:"z.MyIface0", alias:"Hello2", generic:(*gen.Genric)(nil), hmp:gen.HasMethodPrefix(nil), zid:-1}, ShimToBase:"", ShimFromBase:"", Value:0x16, Convert:false, mustinline:false, needsref:false, isIface:true, isInIfaceSlice:false}'
		if err != nil {
			return
		}
	}
	...
	if !empty[3] {
		...
		o, err = msgp.AppendIntf(o, z.MyIface1) // is.iface, gen/marshal.go:237, b='&gen.BaseElem{Common:gen.Common{vname:"z.MyIface1", alias:"Hello2", generic:(*gen.Genric)(nil), hmp:gen.HasMethodPrefix(nil), zid:-1}, ShimToBase:"", ShimFromBase:"", Value:0x16, Convert:false, mustinline:false, needsref:false, isIface:true, isInIfaceSlice:false}'
		if err != nil {
			return
		}
	}
