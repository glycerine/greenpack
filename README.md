...
Version 5.0.1 includes two new features: a) interfaces are supported (manually annotation of interface types is required, using the `msgp:",iface"` tag); and b) de-duplication of pointers and interfaces allows serialization of shared pointers efficiently.
